  ...
  <footer>
  	<div class="container_24">
        ...
        <div class="grid_12">  
			...
			<div class="soc-icons">
					<p>Долучайтся:</p>
				<a href="#"><img src="[(base_url)]images/soc1.png" alt=""></a>
				<a href="#"><img src="[(base_url)]images/soc2.png" alt=""></a>
				<a href="#"><img src="[(base_url)]images/soc3.png" alt=""></a>
				<a href="#"><img src="[(base_url)]images/soc4.png" alt=""></a>
			</div>
        </div>
     </div>
  </footer>';$c['header'] = '<!DOCTYPE html>
{{tml lan}}
<head>
...
[[Wayfinder? &startId=`0` &level=`2`]]
    ...
    </header>';$c['service'] = '[*table*]';$c['spesialist'] = '<div class="grid_16 prefix_1_11">
            	<h2 class="h2 top-3">Наші спеціалісти:</h2>
                <div class="wrap p-border top-8">
                	<div class="box-1">
                    	<div class="img-border"><img src="images/per1.png" alt=""></div>
...
';$c['main_images'] = '<div class="container_24">
...
';$c['main_colum_2'] = '<div class="grid_6 prefix_2">
